...
* **temporal_analysis**: Time series exploration, trend analysis, seasonality detection, autocorrelation, time-based patterns, date-based aggregations, time-window analysis
